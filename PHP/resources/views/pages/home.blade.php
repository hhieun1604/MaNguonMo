...
{{--  <!-- ##### Top Catagory Area Start ##### -->
    ...
    <div class="brands-area d-flex align-items-center justify-content-between">
        ...
        <div class="single-brands-logo">
            <img src="{{ asset('/public/FE/img/core-img/apple-logo.png') }}" alt="">
        </div>
        <div class="single-brands-logo">
            <img src="{{ asset('/public/FE/img/core-img/iphone.png') }}" alt="">
        </div>
        <!-- Brand Logo -->
        <div class="single-brands-logo">
            <img src="{{ asset('/public/FE/img/core-img/imac.png') }}" alt="">
        </div>
        <!-- Brand Logo -->
        <div class="single-brands-logo">
            <img src="{{ asset('/public/FE/img/core-img/ipad.png') }}" alt="">
        </div>
        <!-- Brand Logo -->
        <div class="single-brands-logo">
            <img src="{{ asset('/public/FE/img/core-img/watch.png') }}" alt="">
        </div>
