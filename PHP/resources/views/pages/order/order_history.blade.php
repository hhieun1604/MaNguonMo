...
<table class="table align-middle mb-0 bg-white" >
  ...
  <tbody >
    ...
    <tr>
      ...
      <td style="text-align: center;">
        <a href="{{URL::to('/view-my-order/'.$value->order_id)}}" type="button" class="btn btn-info">View</a>
        @if($value-> order_status != 3 && $value-> order_status != 4)
        <a onclick="return confirm('Are you sure you want cancel?')" href="{{URL::to('/cancel-order/'.$value-> order_id)}}" type="button" class="btn btn-danger">Cancel</a>
        @endif
      </td>
    </tr>
    @endforeach
